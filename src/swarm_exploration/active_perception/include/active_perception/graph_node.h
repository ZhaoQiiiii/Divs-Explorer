...
public:
  ...
  // Main API
  static double searchPath(const Vector3d& p1, const Vector3d& p2, vector<Vector3d>& path, bool optimistic = true);
  static double computeCostLB(const Vector3d& p1, const Vector3d& p2, const double& y1, const double& y2,
                              const Vector3d& v1, const double& yd1, vector<Vector3d>& path, bool optimistic = true);
  static double computeCostCon(const double& y1, const double& y2, const Vector3d& v1);
  static double computeCostToward(const Vector3d& p1, const Vector3d& p2, const double& y1);
